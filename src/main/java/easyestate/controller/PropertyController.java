...
public class PropertyController {
	...
	public String findById(@PathVariable Long id, Model model) {
		...
		User user = userService.findById(property1.getUserid()).get();
		
		UserRegistrationDTO userDTO = userService.userToUserRegistrationDTO(user);
	...
	public String edit(Principal principal, @ModelAttribute("property") Property property, @RequestParam("first_image") MultipartFile firstImage,
		...
		if(!secondImage.isEmpty()) {
			...
			storageService.uploadFile(firstImage, secondImageName);
		...
		return "redirect:/user/properties?saved";
	...
	public String delete(@PathVariable Long id) {
		...
		return "redirect:/user/properties?deleted";
	...
	@PostMapping("/submit")
	public String submit(Principal principal, @ModelAttribute("property") Property property, @RequestParam("first_image") MultipartFile firstImage,
			@RequestParam("second_image") MultipartFile secondImage, @RequestParam("third_image") MultipartFile thirdImage, 
			@RequestParam("fourth_image") MultipartFile fourthImage) throws IOException {
